...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        # self.l1 = TCN_GCN_unit(3, 16, A, residual=False)
        # self.l2 = TCN_GCN_unit(16, 16, A)
        # self.l3 = TCN_GCN_unit(16, 16, A)
        # self.l4 = TCN_GCN_unit(16, 16, A)
        # self.l5 = TCN_GCN_unit(16, 32, A, stride=2)
        # self.l6 = TCN_GCN_unit(32, 32, A)
        # self.l7 = TCN_GCN_unit(32, 32, A)
        # self.l8 = TCN_GCN_unit(32, 64, A, stride=2)
